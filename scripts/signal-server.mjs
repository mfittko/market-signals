...
<style>
  ...
  /* #108: wider default so long NEWSAPI_AI_* labels fit one line; the max-width:900px
     query below still collapses the form to single-column at 92vw on small screens. */
